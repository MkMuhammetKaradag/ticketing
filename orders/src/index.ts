...
import { ExpiirationCompleteListener } from "./events/listeners/expiration-complete-listener";
...
const start = async () => {
  ...
  try {
    ...
    new ExpiirationCompleteListener(natsWrapper.client).listen();
...
app.listen(3000, () => {
  console.log("Listening  on port 3000 local orders");
});
